{
  ...
  "workspaceMount": "source=${localWorkspaceFolder},target=/home/${CONFIG_USER}/pyproject/src,type=bind,consistency=cached", 
  "workspaceFolder": "/home/${CONFIG_USER}/pyproject/src",
  ...
  "appPort": ["${CONFIG_HOSTPORT_RDP}:3389", "${CONFIG_HOSTPORT_EV3DEV2}:6840", "${CONFIG_HOSTPORT_BLUETOOTH}:6841"],
  ...
  "customizations": {
    ...
    "vscode": {
      "settings": {
        "python.venvPath": "/home/${CONFIG_USER}/pyproject",
        "python.defaultInterpreterPath": "/home/${CONFIG_USER}/pyproject/.venv/bin/python",
        "files.exclude": {
          "**/.git": true,
          "**/.svn": true,
          "**/.hg": true,
